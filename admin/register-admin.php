...
if (isset($_POST['submit'])) {
    ...
    $target_dir = "admin/admin-upload/"; //chỉ định thư mục nơi tệp sẽ được đặt
    ...
    if (mysqli_num_rows($res) > 0) {
        ...
        header("Location:" . SITEURL . "register-admin.php?response=$value");
        ...
        if ($res2 > 0) {
            ...
            try {
                ...
                $mail->Subject = $tieude;
                // gui ve thong bao                   
                $linkemail = "http://localhost/danhba/admin/active_user.php?email=" . $email . "&code=" . $code;
                // Mail body content 
            ...
            header("Location:" . SITEURL . "admin/login.php?response=$value");
